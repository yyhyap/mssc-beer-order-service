...
public class BeerOrder extends BaseEntity {
    ...
    /*
    * FetchMode.JOIN loads them eagerly, say via a join:
    * Hibernate:
        select ...
        from
            beer_order beer_order0_
        left outer join
            beer_order_line beer_order_line1
                on beer_order.id=order.beer_order_line_order_id
        where
            beer_order.id=?
    * */
